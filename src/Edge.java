public class Edge {
	...
	public Edge partitionEdge(int index, Node root, char c_new_edge)
		...
		router.setParentEdge(this);// this has to be done after modifying edge,
									// otherwise depth will be set wrong.
		endnode_old.setParentEdge(routerToEndNode);// for setting depth
													// correctly
